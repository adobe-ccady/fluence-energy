...
/**
 * Parser for hero (base variant) — Mosaic page.
 * Base: hero. Source: https://fluenceenergy.com/mosaic-intelligent-bidding-software/
 ...
 *   - row 1 = content row → heading/eyebrow/CTA cell
 * So we emit a 1-column, 2-row table: [ bgImage ] then [ eyebrow + h1 ].
 * The source header carries a real <img> (the Web-Banner swoosh gradient) as a
 * direct child, plus a .banner-title with a p.h4 eyebrow ("Fluence Mosaic") and
 * the <h1>. hero.js promotes the first <p> (eyebrow) to .tag-pill.
 */
export default function parse(element, { document }) {
  ...
  // Row 1: content cell — eyebrow (h4/p) + h1.
  const contentCell = [];
