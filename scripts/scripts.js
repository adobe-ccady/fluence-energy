...
/** Shared brand logo used by the header (color SVG). Footer uses its own white logo. */
export const BRAND_LOGO = `<img class="nav-logo-img" src="${window.hlx?.codeBasePath || ''}/icons/fluence-logo-color.svg" width="175" height="45" alt="Fluence" loading="eager"/>`;
